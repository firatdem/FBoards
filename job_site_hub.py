...
class JobSiteHub:
    ...
    def update_occupation(self, box, occupied, employee_id=None):
        if box == "PM":
            ...
            self.update_electrician_positions()  # Ensure Electrician positions are updated correctly
    ...
    def get_occupation_status(self):
        ...
        return {
            ...
            "Electrician": self.electrician_occupied,  # List of employee IDs
    ...
    def set_occupation_status(self, status):
        ...
        # Apply the exact coordinates from the JSON directly
        ...
        self.update_all_positions()  # This method ensures employees are correctly positioned within their boxes
