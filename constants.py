...
VERTICAL_SPACING = 250  # Constant vertical spacing between rows
ELECTRICIAN_BOX_HEIGHT = 710  # Height of the electrician box
JOB_HUB_WIDTH = 900  # Width of the job site hub
JOB_HUB_HEIGHT = 1100  # Height of the job site hub
BOX_HEIGHT = 90  # Height of the non-electrician boxes
